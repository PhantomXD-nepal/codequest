...
export const Html = () => {
  const titleWords = 'CodeQuest'.split(' ');
  const subtitle = 'Learn. Level Up. Conquer.';
  ...
  return (
    <div className="h-svh relative bg-black">
      <div className="h-svh uppercase items-center w-full absolute z-40 pointer-events-none px-10 flex justify-center flex-col">
        <div className="text-2xl md:text-4xl xl:text-6xl 2xl:text-7xl font-pixel">
        ...
        <div className="text-[10px] md:text-sm xl:text-lg 2xl:text-xl mt-8 overflow-hidden text-white font-pixel tracking-tighter">
          <div
      ...
      <button
        className="explore-btn absolute bottom-10 left-1/2 -translate-x-1/2 z-50 text-white flex flex-col items-center gap-2 opacity-0 animate-[fadeIn_0.5s_ease-in_forwards] font-pixel"
        style={{ animationDelay: '2.2s' }}
      >
        <span className="text-[8px] uppercase tracking-widest">Scroll to explore</span>
        <span className="explore-arrow animate-bounce">
