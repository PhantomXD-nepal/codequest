      ...
      >
        ...
        <form onSubmit={handleSignIn} className="flex flex-col w-full gap-5">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full group bg-transparent border border-white/20 text-white font-bold text-sm uppercase tracking-widest py-4 rounded-xl flex items-center justify-center gap-3 hover:border-[#5ed29c] hover:text-[#5ed29c] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed mt-2"
          >
          ...
          <div className="relative py-6">
            ...
            <div className="relative flex justify-center text-xs uppercase tracking-widest">
              <span className="bg-[#070b0a] px-4 text-white/30">Or continue with</span>
            </div>
          </div>
