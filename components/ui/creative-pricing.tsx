        ...
        <div className="w-full max-w-6xl mx-auto px-4">
            <div className="text-center space-y-6 mb-16">
                ...
                <div className="relative">
                    <h2 className="text-2xl md:text-4xl font-bold font-pixel text-zinc-900 dark:text-white rotate-[-1deg] leading-tight">
                        {title}
                        ...
                        <div className="relative p-6">
                            {tier.popular && (
                                <div
                                    ...
                                    font-pixel px-3 py-1 rounded-full rotate-12 text-[10px] border-2 border-zinc-900"
                                >
                                    Popular!
                                </div>
                            )}
                            ...
                            <div className="mb-6">
                                ...
                                <h3 className="font-pixel text-lg text-zinc-900 dark:text-white mb-2">
                                    {tier.name}
                                </h3>
                            ...
                            {/* Price */}
                            <div className="mb-6">
                                <span className="text-2xl font-bold font-pixel text-zinc-900 dark:text-white">
                                    ${tier.price}
                                </span>
                                <span className="text-zinc-600 dark:text-zinc-400 font-handwritten ml-2">
                                    /month
                                </span>
                            </div>
                            ...
                            <Button
                                className={cn(
                                    "w-full h-12 font-pixel text-xs relative",
                                    "border-2 border-zinc-900 dark:border-white",
                                    "transition-all duration-300",
