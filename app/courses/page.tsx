...
import { Code2, Layout, Terminal, FileType2, FileJson, BookOpen, ArrowLeft, ArrowRight, PlayCircle } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {courses.map((course, index) => (
              ...
              >
                ...
                <p className="text-on-surface-variant font-medium text-sm mb-6 flex-1">{course.description}</p>
                {course.videoUrl && (
                    <div className="mb-6">
                        <a href={course.videoUrl} target="_blank" rel="noreferrer" className="text-primary hover:text-primary-dim text-sm font-bold flex items-center gap-2 transition-colors">
